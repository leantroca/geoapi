    ...
    <UserStyle>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PolygonSymbolizer>
            <Fill>
              <CssParameter name="fill">#9F2B68</CssParameter>
              <CssParameter name="fill-opacity">0.3</CssParameter>
            </Fill>
          </PolygonSymbolizer>
          <LineSymbolizer>
            <Stroke>
              <CssParameter name="stroke">#9F2B68</CssParameter>
        ...
        <Rule>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="png/purple-pushpin.png" />
