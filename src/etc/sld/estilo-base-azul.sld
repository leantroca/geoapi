    ...
    <UserStyle>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PolygonSymbolizer>
            <Fill>
              <CssParameter name="fill">#1F51FF</CssParameter>
              <CssParameter name="fill-opacity">0.3</CssParameter>
            </Fill>
          </PolygonSymbolizer>
          <LineSymbolizer>
            <Stroke>
              <CssParameter name="stroke">#1F51FF</CssParameter>
        ...
        <Rule>
          ...
          <PointSymbolizer>
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="png/blue-pushpin.png" />
